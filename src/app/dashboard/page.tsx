...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen px-6 py-8 bg-[#050407] text-gray-100">
      <div className="mx-auto max-w-6xl grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 lg:col-span-6 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button className="h-9 px-3 rounded-full bg-gray-700 shadow-sm border border-gray-700 text-sm text-gray-100">
                Search
              </button>
              <button className="h-9 w-9 rounded-full bg-gray-700 shadow-sm border border-gray-700 text-gray-100" aria-label="Profile" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="rounded-2xl bg-gradient-to-br from-orange-700 to-orange-500 p-5 shadow-sm border border-orange-600 text-white">
              <div className="flex items-center justify-between">
                ...
                <a className="text-xs text-gray-400">View details</a>
              </div>
              <div className="mt-6 flex items-end justify-between">
                <div>
                  <div className="text-4xl font-semibold">12°C</div>
                  <div className="text-xs text-gray-400 mt-1">Wind 2–4 km/h · Humidity 42%</div>
                </div>
        ...
        <div className="col-span-12 lg:col-span-3 space-y-6">
          <IntegrationsCard />
          <div className="bg-zinc-400 rounded-2xl p-5 shadow-sm border border-zinc-300">
            <div className="flex items-center justify-between">
              <h3 className="font-semibold">Trophies</h3>
              <span className="text-xs text-zinc-700">View</span>
            </div>
            <div className="mt-4 grid grid-cols-2 gap-3">
              <div className="rounded-xl border border-zinc-300 p-3 bg-zinc-400">
